# -*- coding: utf-8 -*-
"""Patcht die Winkel im DRT (Projekt-A): pro Clip in Timeline-Reihenfolge das
Kamera-Byte im FieldsBlob setzen. Mapping: Angle 1 = nah ('1'/0x31),
Angle 2 = weit ('2'/0x32). Nur die Timeline-XML wird ersetzt, Rest 1:1."""
...
exp = "".join("1" if c=="nah" else "2" for c in cams)
got = "".join(digs)
